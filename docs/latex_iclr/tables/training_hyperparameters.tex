\begin{table}[H]
    \caption{Main-experiment training hyperparameters. Learning rate is the only
    optimization hyperparameter selected separately by method; each selected
    value is fixed across all three configurations and reported seeds.}
